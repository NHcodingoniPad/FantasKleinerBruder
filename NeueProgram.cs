namespace FantaExotic
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string SecretWord;
            char letter;
            int SWLength, p1, p2, mistakes, guess, mistaketracker = 0, rightletter = 0;
            ...
            do
            {
                ...
                for (int i = 0; i < Sw.Length; i++)
                {
                    if (Sw[i] == letter)
                    {
                        _[i] = letter;                              // Alles was in der For-schleife steht vergleicht die Buchstaben miteinander
                        rightletter++;
                    }
                    if (letter != Sw[i])
                    {
                ...
                Console.WriteLine("");
            } while (mistakes != 9 && rightletter != _.Length);
